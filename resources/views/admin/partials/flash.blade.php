@if(session()->has('system_flash_messages'))
    ...
    <div style="display: inline-block; margin: 0px auto; position: fixed; transition: all 0.5s ease-in-out 0s; z-index: 1; top: 20px; left: 0px; right: 0px;">
    ...
    @foreach(session()->get('system_flash_messages') as $key => $item)
        ...
        <div data-notify="container" class="mb-2 col-11 col-sm-4 alert alert-{{$key}} alert-with-icon" role="alert"
             data-notify-position="top-center"  style=" margin: auto; z-index: 0">
